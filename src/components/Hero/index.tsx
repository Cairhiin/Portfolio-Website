    ...
    <div className="hero">
      ...
      <div className="hero-content">
        ...
        <div>
          ...
          <div className="hero-content-column">
            <p>
              Years of experience designing, developing and updating a Wordpress
              site for a local newspaper.
            </p>

            <p>
              Check out my projects, skills, GitHub, GitLab, or drop me a line.
